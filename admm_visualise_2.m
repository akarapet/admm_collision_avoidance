...
%plot(value(x{1,1}(1)),value(x{1,1}(2)),'go',value(x{2,1}(1)),value(x{2,1}(2)),'bo',value(x{3,1}(1)),value(x{3,1}(2)),'ro')
plot(value(x{1,1}(1)),value(x{1,1}(2)),'go',value(x{2,1}(1)),value(x{2,1}(2)),'bo')
hold on
